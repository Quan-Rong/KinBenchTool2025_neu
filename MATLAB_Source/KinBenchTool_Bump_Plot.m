...
if contains(filename2,'parallel_travel')
    ...
    Susp_parallel_travel_plot_ID=[toe_angle_ID(1),toe_angle_ID(2),left_tire_contact_point_ID(2),right_tire_contact_point_ID(2),wheel_travel_base_ID(1),...
        ...
        wheel_load_vertical_force_ID(2), side_view_swing_arm_angle_ID(1),side_view_swing_arm_angle_ID(2),side_view_swing_arm_length_ID(1),side_view_swing_arm_length_ID(2),caster_angle_ID(1),caster_angle_ID(1)];
    ...
    % Wheel Rate
    %------------------------------------------------------------------------------------------------------------------------
    P_R_B_Wheelrate_change_left=polyfit(Susp_parallel_travel_plot_data1(Row_No-app.EditField_R_bump_range.Value:Row_No+app.EditField_R_bump_range.Value,17),Susp_parallel_travel_plot_data1(Row_No-app.EditField_R_bump_range.Value:Row_No+app.EditField_R_bump_range.Value,13),1);
    P_R_B_Wheelrate_change_right=polyfit(Susp_parallel_travel_plot_data1(Row_No-app.EditField_R_bump_range.Value:Row_No+app.EditField_R_bump_range.Value,18),Susp_parallel_travel_plot_data1(Row_No-app.EditField_R_bump_range.Value:Row_No+app.EditField_R_bump_range.Value,14),1);

    app.WheelRateSlopeWCEditField.Value =(round(P_R_B_Wheelrate_change_left(1,1),2)+round(P_R_B_Wheelrate_change_right(1,1),2))/2;
    %left---------------------------------------------------
    hold(app.UIAxesLeft_R_B_Wheelrate,'on');

    plot(app.UIAxesLeft_R_B_Wheelrate,Susp_parallel_travel_plot_data1(:,17),Susp_parallel_travel_plot_data1(:,13),'DisplayName','Result','Color',app.ColorPicker_curve.Value,'LineWidth', 1.5);
    plot(app.UIAxesLeft_R_B_Wheelrate,Susp_parallel_travel_plot_data1(Row_No-15:Row_No+15,17),P_R_B_Wheelrate_change_left(1,1)*Susp_parallel_travel_plot_data1(Row_No-15:Row_No+15,17)+P_R_B_Wheelrate_change_left(1,2),...
        'DisplayName','curve fitting [-30mm,30mm]','MarkerIndices',[1 31],'Marker','o','Color',[0 0 1])
    ...
    text(0.5,0.6+0.1*app.toCompareSpinner.Value,['Wheel Rate change =' num2str(P_R_B_Wheelrate_change_left(1,1)) ' N/mm/mm'],'Units', 'normalized','HorizontalAlignment', 'center', 'VerticalAlignment', 'bottom', 'Color',app.ColorPicker_fit.Value,'FontSize',10,'FontName','Times New Roman','Parent',app.UIAxesLeft_R_B_Wheelrate)

    text(0.55, 0.01,'rebound <<                                                          >> bump','Units', 'normalized','HorizontalAlignment', 'center', 'VerticalAlignment', 'bottom','FontSize',10,'FontName','Times New Roman', 'FontWeight', 'bold','Parent',app.UIAxesLeft_R_B_Wheelrate);
    ...
    plot(app.UIAxesRight_R_B_Wheelrate,Susp_parallel_travel_plot_data1(:,18),Susp_parallel_travel_plot_data1(:,14),'DisplayName','Result','Color',app.ColorPicker_curve.Value,'LineWidth', 1.5);
    plot(app.UIAxesRight_R_B_Wheelrate,Susp_parallel_travel_plot_data1(Row_No-15:Row_No+15,18),P_R_B_Wheelrate_change_right(1,1)*Susp_parallel_travel_plot_data1(Row_No-15:Row_No+15,18)+P_R_B_Wheelrate_change_right(1,2),...
        'DisplayName','curve fitting [-30mm,30mm]','MarkerIndices',[1 31],'Marker','o','Color',[0 0 1])
    ...
    text(0.5,0.6+0.1*app.toCompareSpinner.Value,['Wheel Rate change ='  num2str(P_R_B_Wheelrate_change_right(1,1)) ' N/mm/mm'],'Units', 'normalized','HorizontalAlignment', 'center', 'VerticalAlignment', 'bottom', 'Color',app.ColorPicker_fit.Value,'FontSize',10,'FontName','Times New Roman','Parent',app.UIAxesRight_R_B_Wheelrate)

    text(0.55, 0.01,'rebound <<                                                          >> bump','Units', 'normalized','HorizontalAlignment', 'center', 'VerticalAlignment', 'bottom','FontSize',10,'FontName','Times New Roman', 'FontWeight', 'bold','Parent',app.UIAxesRight_R_B_Wheelrate);
